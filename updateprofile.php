                        ...
                        <form id="contact" action="" method="post">
                            <div class="row">
                                <div class="col-md-9 col-sm-12">
                                    <fieldset>
                                        <input name="name" type="text" id="name" placeholder="Your Name:" required="" readonly>
                                    </fieldset>
                                </div>
                                <div class="col-md-9 col-sm-12">
                                    <fieldset>
                                        <input name="email" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Your Email:" required=""readonly>
                                    </fieldset>
                                </div>
                                <div class="col-md-9 col-sm-12">
                                    <fieldset>
                                        <input name="phone-number" type="text" id="phone-number" placeholder="Phone Number:" required=""readonly>
                                    </fieldset>
                                </div>
                                <div class="col-md-9 col-sm-12">
                                    <fieldset>
                                        <input name="age" type="text" id="age" placeholder="Age:" required=""readonly>
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <button type="submit" id="form-submit" class="main-dark-button">Save Changes </button>
                                    </fieldset>
                                </div>
